...
public class DeliveryManManagement extends JFrame{
    ...
    public void setList (DeliveryProfileInterface<DeliveryMan> deliveryProfileList){
        DeliveryManManagement.deliveryProfileList = deliveryProfileList;   // setter for super list object
    }
    
    public DeliveryProfileInterface<DeliveryMan> getList (){
        return DeliveryManManagement.deliveryProfileList;      // getter for super list object
    }
     
    public ScheduleInterface<Schedule> getDeliList (){
        return DeliveryManManagement.deliveryList;      // getter for super list object
    }
